...
<div class="container" id="alert">
	...
	<div class="row">	
		<div class="form-group text-right">
			<form id="search-form" class="form-inline pull-right" action="list.do">
	...
	<!-- 
	 ...
	 -->
				...
				<div class="form-group">
					...
					<a href="/user/list.do" class="btn btn-default">초기화</a>
					</div>
			</form>
		</div>
	</div>
	<div>
		...
		<div class="row text-right">
			<!-- 
			<a href="/user/addform.do" class="btn btn-primary btn-sm" id="btn-new-notice">새 공지 등록</a>
			 -->
		</div>
